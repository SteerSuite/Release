...
// 
//
void ReactiveAIModule::init( const SteerLib::OptionDictionary & options, SteerLib::EngineInterface * engineInfo )
{
...
void ReactiveAIModule::initializeSimulation()
{
	//
...
// cleanupSimulation()
//
void ReactiveAIModule::cleanupSimulation()
{
...
PLUGIN_API SteerLib::ModuleInterface * createModule() { return new ReactiveAIModule; }
