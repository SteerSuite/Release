...
void CompositeBenchmarkTechniquePLE::init() {
...
float CompositeBenchmarkTechniquePLE::getTotalBenchmarkScore(SimulationMetricsCollector * simulationMetrics) { 
...
void CompositeBenchmarkTechniquePLE::printTotalScoreDetails(SimulationMetricsCollector * simulationMetrics, std::ostream & out) {
...
void CompositeBenchmarkTechniquePLE::printAgentScoreDetails(unsigned int agentIndex, SimulationMetricsCollector * simulationMetrics, std::ostream & out) {
